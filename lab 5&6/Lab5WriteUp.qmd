...
Made the `xlxs` file rectangular for effecient use in `R` by stacking data on top of each other.
...
```{r}
#| size: scriptsize
dat.kitsberg.cleaned<- separate(biomed.dat, col="sample", into=c("SampleType", "CellType", "Treatment"), sep="_")
```
...
ggplot(data= dat.kitsberg.cleaned) +
  ...
  labs(
    x= "Cell Types",
    title= "Fig 3b: HCMV genomes detected in the nucleus and cytoplasm of infected monocytes compared to macrophages.",
